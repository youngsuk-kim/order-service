...
data class PhoneNumber(val number: String) {
    init {
        require(me.bread.order.domain.common.PhoneNumber.Companion.isValidPhoneNumber(number)) {
    ...
    companion object {
        ...
        fun isValidPhoneNumber(number: String): Boolean {
            return me.bread.order.domain.common.PhoneNumber.Companion.PHONE_NUMBER_PATTERN.matches(
                number,
            )
        }
    }
